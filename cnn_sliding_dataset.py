...
class OCRIter(mx.io.DataIter):
    def __init__(self, batch_size, classess,dataset_lst, data_shape=(512,32), character_shape=(32,32), num_label=40, character_step=8):
        ...
        self.provide_data = [('data', (self.batch_len, 1, character_shape[0], character_shape[1]))]
        self.provide_label = [('label', (self.batch_len, num_label))]
    ...
    def __iter__(self):
        ...
        label_all = np.zeros(shape=(self.batch_len,self.num_label))
...
#            img_new[0:new_h,0:new_w] = img
            ...
            if cnt % self.batch_size == 0:
                ...
                data_names = ['data']
                label_names = ['label']
                label_all = mx.nd.array(label_all)
...
if __name__=='__main__':
    ...
    data_iter = OCRIter(1,classes,'/home/zhao/IIIT5K/train_check.txt')
    it = iter(data_iter)
    data = next(it)
